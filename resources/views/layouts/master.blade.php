...
<head>
    ...
    <title>Thuê nhà Hải Phòng</title>
...
<body>
    ...
    <div class="page-wrapper">
            ...
            <div class="container">
                <nav class="navbar navbar-expand-md navbar-light">
                    <a class="navbar-brand" href="{{ route('home')}}">
                        <img class="logo-light" src="{{ asset('thuenhahaiphong/assets/img/logo.png')}}" alt="logo">
                        <img class="logo-dark" src="{{ asset('thuenhahaiphong/assets/img/logo.png')}}" alt="logo">
                    </a>
                    <div class="collapse navbar-collapse main-menu-wrap" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav ms-auto">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="nav-item">
                                        <a href="listings-one.html" class="nav-link">Listing Style One
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="listings-two.html" class="nav-link">Listing Style Two
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="listing-details.html" class="nav-link">Single Listings</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="nav-item">
                ...
                <div class="row">
                    <div class="col-xxl-8 offset-xxl-2 col-xl-10 offset-xl-1 col-lg-10 offset-lg-1">
                        ...
                        <div class="client-feedback" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="500">
                            <ul class="list-style">
                                <li><a href="testimonials.html"><img src="assets/img/clients/client-1.jpg"
                                            alt="Image"></a></li>
                                <li><a href="testimonials.html"><img src="assets/img/clients/client-2.jpg"
                                            alt="Image"></a></li>
                                <li><a href="testimonials.html"><img src="assets/img/clients/client-3.jpg"
                                            alt="Image"></a></li>
                                <li><a href="testimonials.html"><img src="assets/img/clients/client-4.jpg"
                                            alt="Image"></a></li>
                            </ul>
        ...
        <section class="city-wrap style3 ptb-100">
            <img src="assets/img/city/city-shape-2.png" alt="Image" class="city-shape-two">
            <div class="container">
                <div class="row">
                ...
                <div class="city-slider-two owl-carousel">
                    <div class="city-card style3">
                        <img src="assets/img/city/city-20.jpg" alt="Image">
                        <p>+231 properties</p>
                        <h3><a href="listings-two.html">Vancuver City</a></h3>
                    </div>
                    <div class="city-card style3">
                        <img src="assets/img/city/city-21.jpg" alt="Image">
                        <p>+121 properties</p>
                        <h3><a href="listings-two.html">Montreal City</a></h3>
                    </div>
                    <div class="city-card style3">
                        <img src="assets/img/city/city-22.jpg" alt="Image">
                        <p>+231 properties</p>
                        <h3><a href="listings-two.html">Los Angeles</a></h3>
                    </div>
                    <div class="city-card style3">
                        <img src="assets/img/city/city-23.jpg" alt="Image">
                        <p>+120 properties</p>
                        <h3><a href="listings-two.html">Florida</a></h3>
                    </div>
                    <div class="city-card style3">
                        <img src="assets/img/city/city-24.jpg" alt="Image">
                        <p>+331 properties</p>
                        <h3><a href="listings-two.html">Pennsylvania</a></h3>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="about-box">
                    ...
                    <div class="row gx-5 align-items-center">
                        <div class="col-lg-6" data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">
                            <div class="about-img-wrap about-bg-1 bg-f">
                            </div>
                        </div>
                        <div class="col-lg-6" data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">
                            <div class="about-content">
                                ...
                                <ul class="content-feature-list list-style">
                                    <li><i class="flaticon-checked"></i> We have a strong customer support in 24/7 days
                                    </li>
        ...
        <section class="property-wrap ptb-100">
            ...
            <div class="property-slider-three owl-carousel">
                ...
                <div class="property-card style5">
                    <div class="property-img">
                        <img src="assets/img/property/property-3.jpg" alt="Image">
                    </div>
                    <div class="property-info">
                        <div class="property-status-wrap">
                            <span class="property-status">For Rent</span>
                        ...
                        <p><i class="flaticon-location"></i>732 Burwell Heights Road, Houston</p>
                        <ul class="property-metainfo list-style">
                ...
                <div class="property-card style5">
                    <div class="property-img">
                        <img src="assets/img/property/property-4.jpg" alt="Image">
                    </div>
                    <div class="property-info">
                        <div class="property-status-wrap">
                            <span class="property-status">For Rent</span>
                ...
                <div class="property-card style5">
                    <div class="property-img">
                        <img src="assets/img/property/property-5.jpg" alt="Image">
                    </div>
                    <div class="property-info">
                        <div class="property-status-wrap">
                            <span class="property-status">For Rent</span>
                        ...
                        <p><i class="flaticon-location"></i>2665 Blair Court, Dalton, Missouri</p>
                        <ul class="property-metainfo list-style">
                ...
                <div class="property-card style5">
                    <div class="property-img">
                        <img src="assets/img/property/property-6.jpg" alt="Image">
                    </div>
                    <div class="property-info">
                        <div class="property-status-wrap">
                            <span class="property-status">For Sale</span>
                ...
                <div class="row">
                    <div class="col-xl-6 offset-xl-3 col-lg-8 offset-lg-2">
                        <div class="section-title style2 text-center mb-40">
                            ...
                            <h2>3 Steps To Book Your Home</h2>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6" data-aos="fade-up" data-aos-duration="1200"
                        ...
                        <div class="hw-card">
                            <div class="hw-img">
                                ...
                                <img src="assets/img/how-it-works/hw-1.png" alt="Image">
                                <span>01</span>
                            </div>
                            <div class="hw-info">
                                <h3>Search &amp; Select</h3>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6" data-aos="fade-up" data-aos-duration="1200"
                        ...
                        <div class="hw-card">
                            <div class="hw-img">
                                <img src="assets/img/how-it-works/hw-shape-1.png" alt="Image" class="hw-shape-one">
                                <img src="assets/img/how-it-works/hw-2.png" alt="Image">
                                <span>02</span>
                            </div>
                            <div class="hw-info">
                                <h3>Reserve The Property</h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor. </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6" data-aos="fade-up" data-aos-duration="1200"
                        ...
                        <div class="hw-card">
                            <div class="hw-img">
                                <img src="assets/img/how-it-works/hw-shape-1.png" alt="Image" class="hw-shape-one">
                                <img src="assets/img/how-it-works/hw-3.png" alt="Image">
                                <span>03</span>
                            </div>
                            <div class="hw-info">
                ...
                <div class="outer">
                    ...
                    <div id="thumbs" class="owl-carousel owl-theme">
                        <div class="video-item">
                            <img src="assets/img/property/property-14.jpg" alt="Image">
                        </div>
                        <div class="video-item">
                            <img src="assets/img/property/property-15.jpg" alt="Image">
                        </div>
                        <div class="video-item">
                            <img src="assets/img/property/property-16.jpg" alt="Image">
                        </div>
                        <div class="video-item">
                            <img src="assets/img/property/property-32.jpg" alt="Image">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="testimonial-slider-three owl-carousel">
                <div class="testimonial-card style3">
                    <p class="client-quote">
                        Lorem ipsum dolor sit amet adip elitions repellat tetur delni vel quam aliq earum explibo dolor
                        eme fugiat enim illumon amet sit.
                    </p>
                ...
                <div class="row gx-5 align-items-center">
                    <div class="col-lg-6" data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">
                        <div class="faq-img-wrap">
                            <img src="assets/img/faq-img-3.png" alt="Image">
                        </div>
                    </div>
                    <div class="col-lg-6" data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">
        ...
        <section class="property-slider-wrap bg-seashell td-cod ptb-100">
            <div class="container">
                <div class="section-title style2 text-center mb-40">
                    <span>RECENTLY AVAILABLE</span>
                    <h2>Easy Price For Home Owners</h2>
                </div>
                <div class="property-slider-one owl-carousel">
                    <div class="property-card style6">
                        <div class="property-img">
                        ...
                        <div class="property-info">
                            ...
                            <h3><a href="listing-details.html">Luxury Villa</a></h3>
                    ...
                    <div class="property-card style6">
                        ...
                        <div class="property-info">
                            ...
                            <h3><a href="listing-details.html">Lake View Apartment</a></h3>
                            <p><i class="flaticon-location"></i>124, 1st Aveneu, High Steet, USA</p>
                            <ul class="property-metainfo list-style">
                                <li><i class="flaticon-double-bed"></i>07</li>
                                <li><i class="flaticon-bath-tub"></i>04</li>
                    ...
                    <div class="property-card style6">
                        ...
                        <div class="property-info">
                            <div class="property-status-wrap">
                                <span class="property-state"><i class="flaticon-home"></i>Apartment</span>
                                <p class="property-price">$24,000/<span>month</span></p>
                            </div>
                            <h3><a href="listing-details.html">Apartment For Rent</a></h3>
                            <p><i class="flaticon-location"></i>989 Upton Avenue, Mailne</p>
                            <ul class="property-metainfo list-style">
                    ...
                    <div class="property-card style6">
                        ...
                        <div class="property-info">
                            ...
                            <h3><a href="listing-details.html">Morningside Apartment</a></h3>
                            ...
                            <div class="login-content">
                                ...
                                <form class="user-form" action="#">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <input id="pwd_4" name="pwd_4" type="password" placeholder="Password"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
...
<!-- Mirrored from templates.hibootstrap.com/fela/default/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 02 Aug 2022 19:25:44 GMT -->
