...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            <a class="btn mb-2 btn-success" href="{{route('admin.testimonial.create')}}"><i class="icon-plus-circle2"></i> Thêm mới</a>
            @if(count($records))
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('admin.testimonial.edit', $record->id)}}">{{$record->name}}</a>
                            </td>
                            <td>
                                {{$record->address}}
                            </td>
...
<script>
    ...
    $('.js-delete').on('click', function() {
        ...
        swal({
            ...
            if (res.value) {
                $.ajax({
                    url: '{{route('admin.location.destroy','idx')}}'.replace(/idx/, id),
